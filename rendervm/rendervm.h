...
typedef enum rendervm_opcode {
    ...
    VM_UINT32_DUP = 0x21,
    VM_UINT32_SWAP = 0x22,
    VM_UINT32_JUMPEM = 0x23,
    VM_UINT32_STORE = 0x24,
    VM_UINT32_LOAD = 0x25,
    VM_UINT32_ADD = 0x26,
    VM_UINT32_SUB = 0x27,
    VM_UINT32_MUL = 0x28,
    VM_UINT32_EQ = 0x29,
    VM_UINT32_JUMPNZ = 0x2a,
    VM_UINT32_JUMPZ = 0x2b,
    VM_UINT32_PUSH = 0x2c,
    VM_FLOAT_POP = 0x2d,
    VM_FLOAT_DUP = 0x2e,
    VM_FLOAT_SWAP = 0x2f,
    VM_FLOAT_JUMPEM = 0x30,
    VM_FLOAT_STORE = 0x31,
    VM_FLOAT_LOAD = 0x32,
    VM_FLOAT_ADD = 0x33,
    VM_FLOAT_SUB = 0x34,
    ...
    VM_VEC2_MUL = 0x42,
    VM_VEC2_EQ = 0x43,
    VM_VEC2_EXPLODE = 0x44,
    VM_VEC2_IMPLODE = 0x45,
    VM_VEC2_MULMAT2 = 0x46,
    VM_VEC2_MULMAT3 = 0x47,
    VM_VEC2_MULMAT4 = 0x48,
    VM_VEC3_POP = 0x49,
    VM_VEC3_DUP = 0x4a,
    VM_VEC3_SWAP = 0x4b,
    VM_VEC3_JUMPEM = 0x4c,
    ...
    VM_VEC3_MUL = 0x51,
    VM_VEC3_EQ = 0x52,
    VM_VEC3_EXPLODE = 0x53,
    VM_VEC3_IMPLODE = 0x54,
    VM_VEC3_MULMAT3 = 0x55,
    VM_VEC3_MULMAT4 = 0x56,
    VM_VEC4_POP = 0x57,
    VM_VEC4_DUP = 0x58,
    VM_VEC4_SWAP = 0x59,
    VM_VEC4_JUMPEM = 0x5a,
    ...
    VM_VEC4_MUL = 0x5f,
    VM_VEC4_EQ = 0x60,
    VM_VEC4_EXPLODE = 0x61,
    VM_VEC4_IMPLODE = 0x62,
    VM_VEC4_MULMAT4 = 0x63,
    VM_MAT2_POP = 0x64,
    VM_MAT2_DUP = 0x65,
    VM_MAT2_SWAP = 0x66,
    VM_MAT2_JUMPEM = 0x67,
    ...
    VM_MAT2_MUL = 0x6c,
    VM_MAT2_EQ = 0x6d,
    VM_MAT2_EXPLODE = 0x6e,
    VM_MAT2_IDENT = 0x6f,
    VM_MAT2_IMPLODE = 0x70,
    VM_MAT2_ROTATE = 0x71,
    VM_MAT2_SCALE = 0x72,
    VM_MAT2_TRANSP = 0x73,
    VM_MAT3_POP = 0x74,
    ...
    VM_MAT3_MUL = 0x7c,
    VM_MAT3_EQ = 0x7d,
    VM_MAT3_EXPLODE = 0x7e,
    VM_MAT3_IDENT = 0x7f,
    VM_MAT3_IMPLODE = 0x80,
    VM_MAT3_ROTATE = 0x81,
    VM_MAT3_SCALE = 0x82,
    VM_MAT3_TRANSL = 0x83,
    VM_MAT3_TRANSP = 0x84,
    ...
    VM_MAT4_MUL = 0x8d,
    VM_MAT4_EQ = 0x8e,
    VM_MAT4_EXPLODE = 0x8f,
    VM_MAT4_IDENT = 0x90,
    VM_MAT4_IMPLODE = 0x91,
    VM_MAT4_ROTATEX = 0x92,
    VM_MAT4_ROTATEY = 0x93,
    VM_MAT4_ROTATEZ = 0x94,
    VM_MAT4_SCALE = 0x95,
    VM_MAT4_TRANSL = 0x96,
    VM_MAT4_TRANSP = 0x97,
    VM__INSEND = 0xff
