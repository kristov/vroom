...
typedef struct vrms_runtime_interface {
    ...
    uint32_t (*create_object_data)(vrms_runtime_t* vrms_runtime, uint32_t scene_id, uint32_t memory_id, uint32_t memory_offset, uint32_t memory_length, uint32_t item_length, uint32_t data_length, vrms_data_type_t type);
    ...
    uint32_t (*create_object_geometry)(vrms_runtime_t* vrms_runtime, uint32_t scene_id, uint32_t vertex_id, uint32_t normal_id, uint32_t index_id);
    uint32_t (*create_object_mesh_color)(vrms_runtime_t* vrms_runtime, uint32_t scene_id, uint32_t geometry_id, float r, float g, float b, float a);
    uint32_t (*create_object_mesh_texture)(vrms_runtime_t* vrms_runtime, uint32_t scene_id, uint32_t geometry_id, uint32_t texture_id, uint32_t uv_id);
