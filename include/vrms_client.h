...
uint32_t vrms_client_create_data_object(vrms_client_t* client, vrms_data_type_t type, int32_t fd, uint32_t memory_offset, uint32_t memory_length, uint32_t value_length);
